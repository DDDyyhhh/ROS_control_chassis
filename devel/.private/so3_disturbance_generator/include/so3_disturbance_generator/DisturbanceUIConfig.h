  ...
  public:
    ...
    public:
      ParamDescription(std::string a_name, std::string a_type, uint32_t a_level,
          std::string a_description, std::string a_edit_method, T DisturbanceUIConfig::* a_f) :
      ...
      virtual void clamp(DisturbanceUIConfig &config, const DisturbanceUIConfig &max, const DisturbanceUIConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const DisturbanceUIConfig &config1, const DisturbanceUIConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, DisturbanceUIConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const DisturbanceUIConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, DisturbanceUIConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const DisturbanceUIConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const DisturbanceUIConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, DisturbanceUIConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
