...
if(NOT "/usr/include/eigen3;/usr/local/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/aarch64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_lio_unilidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/orangepi/catkin_ws/src/point_lio_unilidar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/orangepi/catkin_ws/devel/.private/point_lio_unilidar/lib;/home/orangepi/catkin_ws/devel/lib;/opt/ros/noetic/lib)
